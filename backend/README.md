...
## Project Structure
    ...
    ├── testapiautostoryboa_62892  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_62892`
...
2. Clone this repo and `cd testapiautostoryboa_62892`
